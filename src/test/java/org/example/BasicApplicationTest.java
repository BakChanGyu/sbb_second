...
import org.example.answer.AnswerRepository;
import org.example.question.QuestionRepository;
...
public class BasicApplicationTest {
   ...
   */
    ...
    void t011() {
        ...
        answerRepository.findById(question.getId());
    }
}
